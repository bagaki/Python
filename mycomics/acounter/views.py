...
def checkuserid(request):
    ...
    try:
        ...
        return JsonResponse({'data': 'The Account was registed', 'status': 'error'})
    except Users.DoesNotExist as e:
...
def home(request):
    ...
    book = Comics.objects.all()
    return render(request, 'home/home.html', {'title': 'Home', 'wheelsList':wheelsList, 'comics': book})

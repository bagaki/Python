# 管理员类
from os import path
from day23.hw_guanli.conf.config import *
from day23.hw_guanli.core.school import *
from day23.hw_guanli.core.Teacher import Teacher
from day23.hw_guanli.core.Student import Student
from day23.hw_guanli.core.my_pickle import MyPickle

from day23.hw_guanli.core.school import Classes


class Manager(object):
    menu = [('创建讲师账号','createTeacher'), ('创建学生账号','createStudent'),
            ('查看学校','showSchool'), ('查看讲师','showTeacher'),('查看课程','showCourse'),
    ...
    def createTeacher(self):
        ...
        teacher_name = input('请输入要创建的讲师名字：')
        teacher_pwd = input('请输入要创建的讲师密码：')
        self.showSchool()
        school = input('学校：')
    ...
    def boundClassTeacher(self):
        ...
        :return:
        '''
        print('in boundClass fucntion')
        self.showClasses()
        class_name = input('请输入要指定的班级：')
        self.showTeacher()
        teacher_name = input('请输入指定的讲师：')
...
# 首先以管理员的身份登录
# 登录之后，就应该实例化一个对应身份的对象，manage_obj = Manager(name)
# 管理员对象可以调用所有的方法
